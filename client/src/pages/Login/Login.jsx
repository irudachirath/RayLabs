        ...
        content={
          <div className="p-8">
            ...
            <div className="mt-14 grid space-y-4">
              <button
                className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-[#8F3E97]"
                onClick={handleLogin}
              >
              ...
              <button className="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 group-hover:text-purple-400 focus:bg-purple-50 active:bg-purple-100">
                <div className="relative flex items-center space-x-4 justify-center">
                  ...
                  <span className="block w-max font-semibold tracking-wide text-sm transition text-white duration-300 sm:text-base">
                    Continue with Apple
                  </span>
                </div>
              </button>
