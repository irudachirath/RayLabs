...
const WhyUs = () => {
  return (
    <>
      <div className="w-5/6 m-auto border-b-2 border-white pb-14 pt-20 flex items-center justify-center">
        ...
        <div className="w-3/5 py-auto px-16 grid grid-cols-2 gap-10 gap-x-16 text-left text-white">
          <div className="border-t-2 p-5 pt-10 border-white">
            <BsRobot size="70" />
            <h1 className="py-4 text-3xl font-bold">Automated</h1>
            <p>
          ...
          <div className="border-t-2 p-5 pt-10 border-white">
            ...
            <h1 className="py-4 text-3xl font-bold">Easy to Use</h1>
            <p>
          ...
          <div className="border-t-2 p-5 pt-10 border-white">
            <PiTarget size="70" />
            <h1 className="py-4 text-3xl font-bold">Accurate</h1>
            <p>
          ...
          <div className="border-t-2 p-5 pt-10 border-white">
            <GoRocket size="70" />
            <h1 className="py-4 text-3xl font-bold">Fast</h1>
            <p>
